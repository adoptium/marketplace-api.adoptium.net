...
class ReleaseInfo {
    ...
    @Schema(examples = ["[8,9,10,11,12,13,14]"], description = "The versions for which adopt have produced a ga release")
    val available_releases: Array<Int>

    @Schema(examples = ["[8,11]"], description = "The LTS versions for which adopt have produced a ga release")
    val available_lts_releases: Array<Int>

    @Schema(examples = ["11"], description = "The highest LTS version for which adopt have produced a ga release")
